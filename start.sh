...
nohup java  -jar   -Xms156m -Xmx156m -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=test.hprof 
    mf-item/mf-item-service/target/mf-item-service-1.0-SNAPSHOT.jar  >/dev/null 2>&1 &
echo "Start Condition Experiment Time: ${APPLICATION}"
