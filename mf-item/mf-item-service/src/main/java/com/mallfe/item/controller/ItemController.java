...
public class ItemController {
     ...
     */
    @GetMapping("page")
    public ResponseEntity<PageResult<Sp>> querySpByPage(@RequestParam(value = "page", defaultValue = "1") Integer page, @RequestParam(value = "rows", defaultValue = "5") Integer rows,
                                                        @RequestParam(value = "sortBy", required = false) String sortBy, @RequestParam(value = "desc", defaultValue = "false") Boolean desc,
